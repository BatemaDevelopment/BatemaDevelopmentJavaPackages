...
public class coffeeBeansCalculator {
  ...
  public static void geometryCalculator() {
    ...
    System.out.println("Coffee Beans Calculator Geometry Calculator Menu\n" + lineDivider + "1) Pythagorean Therom\n2) Area of a 2 Dimensonal Shape\n3) Volume of a 3 Dimensional Shape\n4) Graphing Basics\n5) Exit\n" + lineDivider + "Type the number of the desired option and then press return, to open it's sub-menu.");
    
    int geometryCalculatorSelection = sc.newInt();
    
    if (geometryCalculatorSelection > 0 && geometryCalculatorSelection < 6) {
      if (geometryCalculatorSelection === 1) {
        pythagoreanCalculator();
      } else if (geometryCalculatorSelection === 2) {
        geometricAreaMenu();
      } else if (geometryCalculatorSelection === 3) {
        geometricVolumeMenu();
      } else if (geometryCalculatorSelection === 4) {
        graphingBasicsCalculator();
      } else if (geometryCalculatorSelection === 5) {
        exitCaclulator();
      }
    } else {
      errorMessage();
  ...
  public static void algebraCalculator() {
    ...
    System.out.println("Coffee Beans Calculator Algebra Calculator Menu\n" + lineDivider + "1) \n2) \n3) \n4) \n5) Exit\n" + lineDivider + "Type the number of the desired option and then press return, to open it's sub-menu.");
    
    int algebraCalculatorSelection = sc.newInt();
    
    if (algebraCalculatorSelection > 0 && algebraCalculatorSelection < 6) {
      if (algebraCalculatorSelection === 1) {
        
      } else if (algebraCalculatorSelection === 2) {
        
      } else if (algebraCalculatorSelection === 3) {
        
      } else if (algebraCalculatorSelection === 4) {
        
      } else if (algebraCalculatorSelection === 5) {
        exitCaclulator();
      }
    } else {
      errorMessage();
  ...
  public static void calculusCalculator() {
    ...
    System.out.println("Coffee Beans Calculator Calculus Calculator Menu\n" + lineDivider + "1) \n2) \n3) \n4) \n5) Exit\n" + lineDivider + "Type the number of the desired option and then press return, to open it's sub-menu.");
    
    int calculusCalculatorSelection = sc.newInt();
    
    if (calculusCalculatorSelection > 0 && calculusCalculatorSelection < 6) {
      if (calculusCalculatorSelection === 1) {
        
      } else if (calculusCalculatorSelection === 2) {
        
      } else if (calculusCalculatorSelection === 3) {
        
      } else if (calculusCalculatorSelection === 4) {
        
      } else if (calculusCalculatorSelection === 5) {
        exitCaclulator();
      }
    } else {
      errorMessage();
  ...
  public static void chemestryCalculator() {
    ...
    System.out.println(lineDivider);
        ...
        System.out.println("Coffee Beans Chemestry Calculus Calculator Menu\n" + lineDivider + "1) \n2) \n3) \n4) \n5) Exit\n" + lineDivider + "Type the number of the desired option and then press return, to open it's sub-menu.");
    
    int chemestryCalculatorSelection = sc.newInt();
    
    if (chemestryCalculatorSelection > 0 && chemestryCalculatorSelection < 6) {
      if (chemestryCalculatorSelection === 1) {
        
      } else if (chemestryCalculatorSelection === 2) {
        
      } else if (chemestryCalculatorSelection === 3) {
        
      } else if (chemestryCalculatorSelection === 4) {
        
      } else if (chemestryCalculatorSelection === 5) {
        exitCaclulator();
      }
    } else {
      errorMessage();
